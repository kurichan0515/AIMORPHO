    ...
    <View style={s.root}>
      ...
      <FlatList
        ...
        renderItem={({ item: cat }) => {
          ...
          const rewards = ALL_REWARDS.filter(r => r.category === cat);
          return (
            <View style={s.section}>
              ...
              <View style={s.catHeader}>
                ...
                <Text style={s.catCount}>
                  {rewards.filter(r => earnedIds.has(r.id)).length} / {rewards.length}
                </Text>
              </View>
              ...
              <View style={s.grid}>
                {rewards.map(r => {
                  const active = earnedIds.has(r.id);
                  return (
                    <View
                      key={r.id}
                      style={[
                    ...
                    >
                      <Text style={[
                        s.symbol,
                        active ? { color: meta.color } : s.symbolLocked,
                      ]}>
                        {r.symbol}
                      </Text>
                      <Text style={[s.cardName, !active && s.cardNameLocked]}>{r.name}</Text>
